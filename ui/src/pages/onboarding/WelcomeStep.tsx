  ...
  return (
    <div class="onboarding-step welcome-step">
      ...
      <h1 id="onboarding-title">
        {t('onboarding.welcome.title') || 'Welcome to Vauchi'}
      </h1>
      ...
      <ul class="feature-list" aria-label={t('onboarding.welcome.features_label') || 'Key features'}>
        <li>
          <span class="feature-icon" aria-hidden="true">{'\uD83D\uDD12'}</span>
          <div>
            <strong>{t('onboarding.welcome.feature_encrypted') || 'End-to-end encrypted'}</strong>
            <p>{t('onboarding.welcome.feature_encrypted_desc') || 'Only you and your contacts can see your information'}</p>
          </div>
        </li>
        <li>
          <span class="feature-icon" aria-hidden="true">{'\uD83D\uDD04'}</span>
          <div>
            ...
            <p>{t('onboarding.welcome.feature_updates_desc') || 'Change your number? Everyone gets the update automatically'}</p>
          </div>
        </li>
        <li>
          <span class="feature-icon" aria-hidden="true">{'\uD83D\uDC65'}</span>
          <div>
            ...
            <p>{t('onboarding.welcome.feature_exchange_desc') || 'Share contact cards by scanning QR codes face to face'}</p>
          </div>
        </li>
      </ul>
